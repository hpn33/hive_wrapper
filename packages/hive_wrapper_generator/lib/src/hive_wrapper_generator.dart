...
import 'package:hive_wrapper_generator/src/templates/assert.dart';
import 'package:hive_wrapper_generator/src/templates/copy_with.dart';
import 'package:hive_wrapper_generator/src/templates/parameter_template.dart';
import 'package:hive_wrapper_generator/src/templates/properties.dart';
import 'package:hive_wrapper_generator/src/templates/prototypes.dart';
import 'package:hive_wrapper_generator/src/templates/tear_off.dart';
import 'package:hive_wrapper_generator/src/tools/recursive_import_locator.dart';
import 'package:hive_wrapper_generator/src/utils.dart';
...
@immutable
class HiveWrapperGenerator
    extends ParserGenerator<GlobalData, Data, HiveWrapperAn> {
  HiveWrapperGenerator(this.configs);
